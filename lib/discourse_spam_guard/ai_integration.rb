...
module DiscourseSpamGuard
  class AiIntegration
    ...
    def self.available?
      SiteSetting.spam_guard_ai_integration && defined?(::AiSpamLog) && ::AiSpamLog.table_exists?
    end
    ...
    def self.enqueue_reconciliation(review)
      ...
      DB.after_commit do
        Jobs.enqueue_in(5.seconds, :spam_guard_reconcile_ai, user_id: review.target_created_by_id)
      end
    end
