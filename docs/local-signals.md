# Local signals (policy version 4)
...
| Confirmed spam | Distinct posts with spam flags agreed with by human staff in the last 30 days | +25 per post, capped at 50 |

Duplicate and burst contributions share a 25-point cap. Total local points are
capped at 50. One posting signal produces watch; combined posting evidence or
